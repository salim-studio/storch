"""etorch — مطابقة PyTorch API، أسرع على CPU.
...
مصادر السرعة (بدون compiler):
1. float32 + C-contiguous افتراضياً (أفضل BLAS/SIMD).
2. element-wise متعدد الخيوط للمصفوفات الكبيرة.
3. fused ops: Linear(+bias)(+ReLU)، خطوات SGD/Adam in-place.
4. autograd تكراري بدون recursion + fast path تحت no_grad.
"""
...
from .utils.data import DataLoader, TensorDataset, Dataset
